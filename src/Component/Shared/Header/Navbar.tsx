...
//   const { open, count } = useSelector((state: RootState) => state.Cart);

//   const removeFromCart = () => {
//     dispatch(closeDialog());
//   };
//   const dispatch = useDispatch();
//   const cartitems = useSelector((state) => state.Cart); // Check if this path is correct

//   console.log("Cart Items:", cartitems); // Debugging line to check the content of cartitems
