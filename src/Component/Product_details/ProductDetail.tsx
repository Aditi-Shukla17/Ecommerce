...
const ProductDetail: React.FC = () => {
  return (
    <section className="bg-black text-white py-10 sm:py-20">
      ...
      <div className="bg-gray-700 p-4 sm:p-6 max-w-screen-xl mx-auto mt-6 flex ">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 h-auto w-[1000px]">
       
          <div className="col-span-1 border-dotted border-2 border-gray-600 rounded-lg overflow-hidden ">
            <img
              src={img.src} 
              alt="Main Outfit"
          ...
          <div className="col-span-2 grid grid-rows-2 gap-4 w-1/2">
            <div className="border-dotted border-2 border-gray-600 rounded-lg overflow-hidden h-[200px]">
              <img
                src={img.src} 
                alt="Side Outfit 1"
                className="object-cover w-full h-full"
      ...
      <div className="bg-gray-900 text-white  max-w-screen-xl mx-auto  border-dotted border-2 border-gray-600 rounded-lg">
        <div className="grid grid-cols-1 md:grid-cols-2 ">
          {/* Left Section */}
          <div className="">
            <h2 className="text-xl sm:text-2xl font-bold mb-16  ml-5 mt-5 p-6">
          ...
          <div className="border-dotted border-2 border-gray-600 ">
            ...
            <div className=" border-dotted border-l-0 border-r-0 border-b-0 border-2 p-12 border-gray-600 flex justify-between">
              <div>
            ...
            <div className="p-12">
              ...
              <div className="flex justify gap-3 min-w-[224px] max-w-full text-base text-grey-50 font-roboto">
                {[5, 4, 3, 2, 1].map((index) => (
                  <div
                    key={index}
                  ...
                  >
                    ...
                    <div className="flex-1 flex flex-col items-start justify-start pt-1 px-0 pb-0 box-border min-w-[179px]">
                      <div className=" rounded-81xl bg-dark-10  flex flex-row items-start justify-start ">
